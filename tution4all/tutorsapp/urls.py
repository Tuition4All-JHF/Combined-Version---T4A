...
from .views import (
    ...
    StudentSubmissionCreate, ParentAssignmentStatsView,
)
from .admin_views import AdminSubjectDelete

router = DefaultRouter()
router.register(r'schedule-slots', views.LiveClassViewSet, basename='schedule-slot')
router.register(r'study-notes', views.CourseNoteViewSet, basename='study-note')
...
urlpatterns = [
    ...
    path('admin/courses/pending/', admin_views.AdminPendingCourses.as_view(), name='admin-courses-pending'),
    path('admin/courses/<int:course_id>/approve/', admin_views.AdminApproveCourse.as_view(), name='admin-approve-course'),
    ...
    path('assignments/<int:pk>/submit/', StudentSubmissionCreate.as_view(), name='assignment-submit'),
